...
app.delete("/dropguardAttendances/:guardId", guardAttendanceController.dropGuardAttendance)
app.post("/getAttendances",guardAttendanceController.getAttendanceByGuard)
